...
#Save for now
#write.csv(allData, 'processedData/Wadeable_ProbMon_2001-2018.csv', row.names = F)
rm(landcover); rm(files)
```
...
surveyDataALL <- read_csv('processedData/Wadeable_ProbMon_2001-2018.csv')
...
surveyDataMCCU <- select(surveyDataALL,-c(MetalCCU)) %>%
  ...
  select(DataSource,StationID,Year,StationID_Trend,LongitudeDD,LatitudeDD,stratum,designweight,
         ...
         designweighttrend, designweightoriginal,filwgt_trend,filwgt_orgil,DO,pH,SpCond,TN,TP,TDS,NH4,
...
#write.csv(surveyDataMCCU,'processedData/Wadeable_ProbMon_2001-2018.csv', row.names = F)
