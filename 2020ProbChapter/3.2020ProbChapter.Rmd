...
##### Figure 2.4-6. Virginia probabilistic monitoring wadeable and boatable sites from 2001 - `r IRyearWindowEnd` (n = `r sum(nrow(boatableWshd), nrow(allProb))`).
